...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // siapkan token untuk vaidation user 
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config = [
            ...
            'smtp_user' => '99mdonline@gmail.com',
            'smtp_pass' => 'mdonline123',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('99mdonline@gmail.com', 'Haris Maulana');
        ...
        if ($type == 'verify') {
            ...
            $this->email->message('Click This Link to reset you password : <a 
    ...
    //                 $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">' . $email . ' Hass been Activated, Please Login!!</div>');
    //                 redirect('auth');
    //             } else {
    ...
    //             }
    //         } else {
    //             $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Account activation failed!! Token Wrong.
    //             </div>');
    //             redirect('auth');
    //         }
    //     } else {
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!$user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Please Chechk your email to reset your password </div>');
                redirect('auth/forgotpassword');
            }
        }
    }
